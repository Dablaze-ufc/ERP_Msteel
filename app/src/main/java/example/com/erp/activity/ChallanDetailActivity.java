...
public class ChallanDetailActivity extends AppCompatActivity {
    ...
    private void getTransactionItem(String id) {
        ...
        Call<Orders.OrderDetail> call = apiInterface.getChallanDetail(id);
        call.enqueue(new Callback<Orders.OrderDetail>() {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (message != null) {
                        if (message.success.equals("2")) {
                            ...
                            LayoutAnimationController controller = AnimationUtils.loadLayoutAnimation(ChallanDetailActivity.this, R.anim.down_to_up);
                            recyclerView.setLayoutAnimation(controller);
                            transactionItemAdapter.notifyDataSetChanged();
                        } else {
                            Toast.makeText(ChallanDetailActivity.this, message.message, Toast.LENGTH_LONG).show();
                        }
                    }
                } else {
                    progressDialog.dismiss();
                    Toast.makeText(ChallanDetailActivity.this, "Error :" + response.errorBody(), Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<Orders.OrderDetail> call, @NonNull Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(ChallanDetailActivity.this, "Error :" + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
                ...
                if (response.isSuccessful()) {
                    ...
                    if (message != null) {
                        if (message.getSuccess().equals("2")) {
                            Toast.makeText(ChallanDetailActivity.this, message.getMessage(), Toast.LENGTH_LONG).show();
